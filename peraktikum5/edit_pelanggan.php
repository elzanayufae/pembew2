  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="code" name="nama" type="text" class="form-control" 
        value="">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="kode" name="kode" 
         type="text" class="form-control" value="<?php if (isset($_GET["idedit"])) {echo $row["kode"];}?>">
         <?php if (isset($_GET["idedit"])) {
            echo '<input id="" name="idedit" type="hidden" class="form-control" value="' .$_GET["idedit"].'">';
         } ?>
      </div>
    </div>
  </div>
  <div class="form-group row">
    <label for="stok" class="col-4 col-form-label">nama pelanggan</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="name" name="name" value="<?php if (isset($_GET["idedit"])) {echo $row["nama"];}?>"
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="jk" name="jk" 
        value="P" type="radio" class="form-control" <?php if(isset($_GET["idedit"])) {if($row["jk"] == "L"){echo "checked";}} ?>> Perempuan
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tgl_lahir" name="tgl_lahir" value="<?php if (isset($_GET["idedit"])) {echo $row["tgl_lahir"];} ?>"
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" value="<?php if (isset($_GET["idedit"])) {echo $row["email"];} ?>"
  ...
  <div class="form-group row">
         ...
         <div class="col-8">
            <?php
                ...
                ?>
            <select name="kartu_id" id="kartu_id" class="custom_select">
                <?php 
                if (isset($_GET["idedit"])) {
